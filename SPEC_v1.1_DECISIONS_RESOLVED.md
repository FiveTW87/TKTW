...
| ID | เรื่อง | ข้อสรุป |
|---|---|---|
| OD-001 | “ส่งไปส่อง” | **Closed — ไม่ใช่ Bug** ทดสอบใหม่แล้วทำงานถูกต้อง เป็นความเข้าใจคลาดเคลื่อน จึงไม่ต้องแก้ Logic |
...
#### ENG-003 — “ส่งไปส่อง” — Closed / No Code Change

ทดสอบการเล่นใหม่แล้วพบว่าระบบทำงานถูกต้อง ปัญหาเดิมเกิดจากความเข้าใจคลาดเคลื่อน

ข้อกำหนด:

- ไม่แก้ Engine หรือ UI สำหรับรายการนี้
- ไม่เปลี่ยนกลไกเพื่อให้ต่างจากพฤติกรรมปัจจุบัน
- หากมี Test เดิมอยู่ ให้คงไว้เป็น Regression Test
- ปิด Issue โดยระบุว่า `Not a bug / Works as intended`
